...
function xc_ar() {
    var yy = xcYearPrefix + xc_ck(this.il) + xcYearSuffix,
        mm = xcMonthPrefix + xcMonthNames[this.month] + xcMonthSuffix;
...
function xc_ao() {
    var s = "", fb = 0, fc = xcCSSFootToday, ex = xcCSSFootClear, ew = xcCSSFootBack, ey = xcCSSFootClose,
        fa = xcCSSFootReset;
    ...
    if (fb > 0) {
        ...
        var hx = "xc_ds(" + fo + ",0)", bw = "xc_az(" + fo + ")", aw = "xc_ef(" + fo + ")", by = "xc_cm(" + fo + ")",
            gy = "xc_ea(" + fo + ")";
        var ez = [{
