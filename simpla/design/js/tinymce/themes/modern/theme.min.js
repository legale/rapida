!function () {
    ...
    var e, t, n, i, r, o = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
        l = tinymce.util.Tools.resolve("tinymce.EditorManager"), w = tinymce.util.Tools.resolve("tinymce.util.Tools"),
        d = function (e) {
            return !1 !== c(e)
        }, c = function (e) {
        ...
        }, p = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), v = tinymce.util.Tools.resolve("tinymce.ui.Factory"),
        b = tinymce.util.Tools.resolve("tinymce.util.I18n"), s = function (e) {
        ...
        }, R = tinymce.util.Tools.resolve("tinymce.geom.Rect"), u = tinymce.util.Tools.resolve("tinymce.util.Delay"),
        C = function (e) {
            return function () {
                return e
            }
            ...
            }, constant: C, identity: function (e) {
                return e
        ...
        }, S = H.never, M = H.always, T = function () {
            return P
        }, P = (i = {
            fold: function (e, t) {
                return e()
            }, is: S, isSome: S, isNone: M, getOr: n = function (e) {
                return e
            }, getOrThunk: t = function (e) {
                return e()
            }, getOrDie: function (e) {
                throw new Error(e || "error: getOrDie called on none.")
            }, or: n, orThunk: t, map: T, ap: T, each: function () {
            }, bind: T, flatten: T, exists: S, forall: M, filter: T, equals: e = function (e) {
                return e.isNone()
            }, equals_: e, toArray: function () {
                return []
            }, toString: H.constant("none()")
        }, Object.freeze && Object.freeze(i), i), W = function (n) {
            var e = function () {
                return n
            }, t = function () {
                return r
                ...
                fold: function (e, t) {
                    ...
                    return n === e
                }, isSome: M, isNone: S, getOr: e, getOrThunk: e, getOrDie: e, or: t, orThunk: t, map: function (e) {
                    return W(e(n))
                }, ap: function (e) {
                    ...
                    e(n)
                }, bind: i, flatten: e, exists: i, forall: i, filter: function (e) {
                    return e(n) ? r : P
                }, equals: function (e) {
                    return e.is(n)
            ...
            getUiContainerDelta: function (e) {
                ...
                if (t && "static" !== p.DOM.getStyle(t, "position", !0)) {
                    var n = p.DOM.getPos(t), i = t.scrollLeft - n.x, r = t.scrollTop - n.y;
            ...
            }, getUiContainer: N, inheritUiContainer: function (e, t) {
                return t.uiContainer = N(e)
            }
        }, B = function (i, e, r) {
            var o, s = [];
            ...
            var i, o = function () {
                ...
                if (!x.removed) {
                    ...
                    var g, p, v, b = A.getUiContainerDelta(s).getOr({x: 0, y: 0});
                    ...
                    x.inline || (o.w = x.getDoc().documentElement.offsetWidth), x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = R.inflate(r, 0, 8)), n = R.findBestRelativePosition(i, r, o, l), r = R.clamp(r, o), n ? (a = R.relativePosition(i, r, n), F(s, U(u, a.x, a.y, r, o, i))) : (o.h += i.h, (r = R.intersect(o, r)) ? (n = R.findBestRelativePosition(i, r, o, ["bc-tc", "bl-tl", "br-tr"])) ? (a = R.relativePosition(i, r, n), F(s, U(u, a.x, a.y, r, o, i))) : F(s, U(u, r.x, r.y, r, o, i)) : s.hide()), g = s, v = function (e, t) {
                        return e === t
                    }, p = (p = n) ? p.substr(0, 2) : "", w.each({t: "down", b: "up"}, function (e, t) {
                ...
                }), A.setUiContainer(x, t), function (e) {
                    if (!i) {
                        var t = r(!0), n = A.getUiContainer(e);
            ...
            return -1
        }, ee = Array.prototype.push, te = function (e) {
            ...
            for (var n = 0, i = e.length; n < i; ++n) if (!0 !== t(e[n], n, e)) return !1;
            return !0
        }, ie = Array.prototype.slice, re = q.isFunction(Array.from) ? Array.from : function (e) {
            return ie.call(e)
        }, oe = {
            map: X, each: J, eachr: G, partition: function (e, t) {
                for (var n = [], i = [], r = 0, o = e.length; r < o; r++) {
                    var s = e[r];
                    (t(s, r, e) ? n : i).push(s)
                }
                return {pass: n, fail: i}
            }, filter: K, groupBy: function (e, t) {
                ...
                return D.none()
            }, findIndex: Z, flatten: te, bind: function (e, t) {
                var n = X(e, t);
                return te(n)
            }, forall: ne, exists: function (e, t) {
                return Z(e, t).isSome()
            }, contains: $, equal: function (e, n) {
            ...
            var i, o, s, a, l, u, c, d;
            return e ? (o = e[r], a = !0) : o = se[r], o && (i = {text: o.title}, s = [], w.each((o.items || "").split(/[ ,]/), function (e) {
                var t = ae(e, n[e]);
                t && s.push(t)
            ...
            for (var t, n = [], i = function (e) {
                var t, n = [], i = h(e);
                if (i) for (t in i) n.push(t); else for (t in se) n.push(t);
                return n
            }(e), r = w.makeMap((t = e, t.getParam("removed_menuitems", "")).split(/[ ,]/)), o = c(e), s = "string" == typeof o ? o.split(/[ ,]/) : i, a = 0; a < s.length; a++) {
                var l = s[a], u = ue(e.menuItems, h(e), r, l);
                u && n.push(u)
            }
            return n
        }, de = p.DOM, fe = function (e) {
        ...
        }, me = he, ge = function (e, t, n) {
            var i = e.getContentAreaContainer();
            he(e, i.clientWidth + t, i.clientHeight + n)
        }, pe = tinymce.util.Tools.resolve("tinymce.Env"), ve = function (e, t, n) {
            ...
            return function (e) {
                var t, n, i, r, o, s = e.control, a = s.parents().filter("panel")[0], l = a.find("#" + d)[0],
            ...
            if (!1 === m(t) && n.skinUiCss ? _e.styleSheetLoader.load(n.skinUiCss, we(t)) : we(t)(), i = e.panel = v.create({
                ...
                items: [{
                    type: "container",
                    classes: "top-part",
                    items: [!1 === d(t) ? null : {type: "menubar", border: "0 0 1 0", items: ce(t)}, z(t, f(t))]
                }, ye(t) ? (s = t, {
                    type: "panel",
                    layout: "stack",
            ...
            return x(t), t.on("SwitchMode", (a = i, function (e) {
                ...
                i.remove(), i = null
            }), _(t, i), V(t), {iframeContainer: i.find("#iframe")[0].getEl(), editorContainer: i.getEl()}
        }, ke = tinymce.util.Tools.resolve("tinymce.dom.DomQuery"), Ee = 0, He = {
            id: function () {
                return "mceu_" + Ee++
    ...
    var Pe = function () {
            var e = window, t = Math.max(e.pageXOffset, document.body.scrollLeft, document.documentElement.scrollLeft),
            ...
            return n && !Me(e) ? {x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1} : Pe()
        }, De = {
            testMoveRel: function (e, t) {
                ...
                return s && Se(s) && !Me(n) && (e -= s.scrollLeft, t -= s.scrollTop), s && (e += 1, t += 1), n.state.get("rendered") ? n.layoutRect({
                    x: e,
                    y: t
                }).repaint() : (n.settings.x = e, n.settings.y = t), n.fire("move", {x: e, y: t}), n
            }
        }, Ne = tinymce.util.Tools.resolve("tinymce.util.Class"),
        Ae = tinymce.util.Tools.resolve("tinymce.util.EventDispatcher"), Be = function (e) {
            var t;
    ...
    var Ie, Fe, Ue,
        ...
        }), $e = Array.prototype.push, Xe = Array.prototype.slice;
    Ue = {
    ...
    var Je = Ye.Collection = Fe, Ge = function (e) {
    ...
    var Qe, et, tt = Ne.extend({
        Mixins: [Ke], init: function (e) {
            var t, n;
    ...
    }, rt = "onmousewheel" in document, ot = !1, st = 0, at = {
        Statics: {classPrefix: "mce-"}, isRtl: function () {
            return et.rtl
        }, classPrefix: "mce-", init: function (t) {
            var e, n, i = this;
            ...
            i.settings = t = w.extend({}, i.Defaults, t), i._id = t.id || "mceu_" + st++, i._aria = {role: t.role}, i._elmCache = {}, i.$ = ke, i.state = new tt({
                visible: !0,
                active: !1,
                disabled: !1,
                value: ""
            ...
            var e, t, n, i, r, o, s, a, l, u, c = this, d = c.settings, f = c.getEl();
            ...
            var h = e.left + e.right, m = e.top + e.bottom, g = d.maxWidth || 65535, p = d.maxHeight || 65535;
            ...
            var t, n, i, r, o, s = this, a = s._layoutRect;
            ...
            if ((t = t || {}).control || (t.control = this), t = lt(this).fire(e, t), !1 !== n && this.parent) for (var i = this.parent(); i && !t.isPropagationStopped();) i.fire(e, t, !1), i = i.parent();
            return t
            ...
            var t, e, n = this, i = n.getEl(), r = n.parent();
            if (n.items) {
            ...
            var e, t, n, i, r, o = this, s = o.settings;
            ...
            var t, n, i, r, o, s, a = this.getEl(), l = a.parentNode, u = function (e, t) {
                var n, i, r = e;
    ...
    function ut(a) {
        ...
        function u(e) {
            var t, n, i, r = a.getParentCtrl(e.target), o = l._lastHoverCtrl, s = 0;
            if (r !== o) {
    ...
    var ct = et = Ne.extend(at), dt = function (e) {
    ...
    var ht = {}, mt = ct.extend({
        init: function (e) {
            ...
            return w.isArray(e) || (e = [e]), w.each(e, function (e) {
                e && (e instanceof ct || ("string" == typeof e && (e = {type: e}), t = w.extend({}, n.settings.defaults, e), e.type = t.type = t.type || e.type || n.settings.defaultType || (t.defaults ? t.defaults.type : null), e = v.create(t)), i.push(e))
            }), i
        }, renderNew: function () {
            var i = this;
            ...
            })), t.parent() || (t.keyboardNav = ft({root: t})), t
        }, initLayoutRect: function () {
            var e = this._super();
    ...
    var vt, bt, yt, xt, wt = {
        init: function () {
            ...
            function n() {
                ...
                function t(e, t, n, i, r, o) {
                    ...
                    if (a = p.getEl("scroll" + e)) {
                        ...
                        ke(a).css("display", "block"), s = p.getEl("body"), l = p.getEl("scroll" + e + "t"), u = s["client" + n] - 2 * v, c = (u -= m && g ? a["client" + o] : 0) / s["scroll" + n], (d = {})[f] = s["offset" + t] + v, d[h] = u, ke(a).css(d), (d = {})[f] = s["scroll" + t] * c, d[h] = u * c, ke(l).css(d)
                    }
                }
            ...
            p.settings.autoScroll && (p._hasScroll || (p._hasScroll = !0, function () {
                function e(s, a, l, u, c) {
                    var d, e = p._id + "-scroll" + s, t = p.classPrefix;
        ...
        Defaults: {layout: "fit", containerCls: "panel"}, Mixins: [wt], renderHtml: function () {
        ...
        vt || (vt = function (e) {
            2 !== e.button && function (e) {
                for (var t = Ct.length; t--;) {
                    var n = Ct[t], i = n.getParentCtrl(e.target);
    ...
    function St(r) {
        ...
        function t(e, t) {
            for (var n, i = 0; i < Ct.length; i++) if (Ct[i] !== r) for (n = Ct[i].parent(); n && (n = n.parent());) n === r && Ct[i].fixed(e).moveBy(0, t).repaint()
        }

        r.settings.autofix && (r.state.get("fixed") ? r._autoFixY > e && (r.fixed(!1).layoutRect({y: r._autoFixY}).repaint(), t(!1, r._autoFixY - e)) : (r._autoFixY = r.layoutRect().y, r._autoFixY < e && (r.fixed(!0).layoutRect({y: 0}).repaint(), t(!0, e - r._autoFixY))))
    }

    function Mt(e, t) {
        var n, i, r = Tt.zIndex || 65535;
        if (e) kt.push(t); else for (n = kt.length; n--;) kt[n] === t && kt.splice(n, 1);
        if (kt.length) for (n = 0; n < kt.length; n++) kt[n].modal && (r++, i = kt[n]), kt[n].getEl().style.zIndex = r, kt[n].zIndex = r, r++;
    ...
    var Wt = function (e, t) {
        ...
        var a, n, l = p.DOM, i = s.getParam("fixed_toolbar_container");
        i && (n = l.select(i)[0]);
        var r = function () {
            if (a && a.moveRel && a.visible() && !a._fixed) {
                var e = s.selection.getScrollContainer(), t = s.getBody(), n = 0, i = 0;
                if (e) {
                    var r = l.getPos(t), o = l.getPos(e);
            ...
            a ? a.visible() || o() : (a = e.panel = v.create({
                ...
                fixed: Wt(n, s),
                border: 1,
                items: [!1 === d(s) ? null : {type: "menubar", border: "0 0 1 0", items: ce(s)}, z(s, f(s))]
    ...
    function Nt(i, r) {
        var o, s, a = this, l = ct.classPrefix;
        a.show = function (e, t) {
            function n() {
    ...
    var At = function (e, t) {
        ...
        e.on("ProgressState", function (e) {
            n = n || new Nt(t.panel.getEl("body")), e.state ? n.show(e.time) : n.hide()
        })
    }, Bt = function (e, t, n) {
        var i = function (e) {
            var t = e.settings, n = t.skin, i = t.skin_url;
            if (!1 !== n) {
                var r = n || "lightgray";
        ...
        return i && (n.skinUiCss = i + "/skin.min.css", e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")), At(e, t), e.getParam("inline", !1, "boolean") ? Dt(e, t, n) : Ce(e, t, n)
    }, Ot = ct.extend({
        Mixins: [De], Defaults: {classes: "widget tooltip tooltip-n"}, renderHtml: function () {
        ...
        init: function (i) {
            ...
            return this._tooltip || (this._tooltip = new Ot({type: "tooltip"}), A.inheritUiContainer(this, this._tooltip), this._tooltip.renderTo()), this._tooltip
        }, postRender: function () {
        ...
        Defaults: {value: 0}, init: function (e) {
            ...
            var e = this._id, t = this.classPrefix;
        ...
        Mixins: [De], Defaults: {classes: "widget notification"}, init: function (e) {
            var t = this;
            ...
            var e, t = this, n = t.classPrefix, i = "", r = "", o = "";
    ...
    function Ut(o) {
        ...
        return {
            open: function (e, t) {
                var n, i = w.extend(e, {maxWidth: (n = s(o), He.getSize(n).width)}), r = new Ft(i);
    ...
    var $t = Tt.extend({
        ...
        recalc: function () {
            var e, t, n, i, r = this, o = r.statusbar;
            r._fullscreen && (r.layoutRect(He.getWindowSize()), r.layoutRect().contentH = r.layoutRect().innerH), r._super(), e = r.layoutRect(), r.settings.title && !r._fullscreen && (t = e.headerW) > e.w && (n = e.x - Math.max(0, t / 2), r.layoutRect({
                w: t,
                x: n
            }), i = !0), o && (o.layoutRect({w: r.layoutRect().innerW}).recalc(), (t = o.layoutRect().minW + e.deltaW) > e.w && (n = e.x - Math.max(0, t - e.w), r.layoutRect({
                w: t,
                x: n
            }), i = !0)), i && r.recalc()
        },
        initLayoutRect: function () {
            var e, t = this, n = t._super(), i = 0;
        ...
        renderHtml: function () {
            var e = this, t = e._layout, n = e._id, i = e.classPrefix, r = e.settings, o = "", s = "", a = r.html;
        ...
        fullscreen: function (e) {
            var n, t, i = this, r = document.documentElement, o = i.classPrefix;
            if (e !== i._fullscreen) if (ke(window).on("resize", function () {
                var e;
    ...
    !function () {
        if (!pe.desktop) {
            ...
            u.setInterval(function () {
                ...
                n.w === e && n.h === t || (n = {w: e, h: t}, ke(window).trigger("resize"))
            }, 100)
        }
    ...
    var Xt, Jt = $t.extend({
            init: function (e) {
                ...
                OK: 1, OK_CANCEL: 2, YES_NO: 3, YES_NO_CANCEL: 4, msgBox: function (e) {
                    ...
                    return "string" == typeof e && (e = {text: e}), e.callback = t, Jt.msgBox(e)
                }, confirm: function (e, t) {
                    return "string" == typeof e && (e = {text: e}), e.callback = t, e.buttons = Jt.OK_CANCEL, Jt.msgBox(e)
                }
            }
        }), Gt = function (n) {
            return {
            ...
            Defaults: {classes: "widget btn", role: "button"}, init: function (e) {
                ...
                var e, t, n = this, i = n._id, r = n.classPrefix, o = n.state.get("icon"), s = n.state.get("text"), a = "",
                    l = n.settings;
                ...
                var o = this, n = o.$, i = o.classPrefix + "txt";
                ...
                return o.state.on("change:text", function (e) {
                    ...
                    var t = e.value, n = o.classPrefix;
                    t = (o.settings.icon = t) ? n + "ico " + n + "i-" + o.settings.icon : "";
                    var i = o.getEl().firstChild, r = i.getElementsByTagName("i")[0];
            ...
            init: function (e) {
                ...
                var n = this, t = He.create("input", {type: "file", id: n._id + "-browse", accept: n.settings.accept});
        ...
        }), rn = tinymce.util.Tools.resolve("tinymce.util.VK"), on = zt.extend({
            init: function (i) {
                var r = this;
                r._super(i), i = r.settings, r.classes.add("combobox"), r.subinput = !0, r.ariaTarget = "inp", i.menu = i.menu || i.values, i.menu && (i.icon = "caret"), r.on("click", function (e) {
                    var t = e.target, n = r.getEl();
                    if (ke.contains(n, t) || t === n) for (; t && t !== n;) t.id && -1 !== t.id.indexOf("-open") && (r.fire("action"), i.menu && (r.showMenu(), e.aria && r.menu.items()[0].focus())), t = t.parentNode
                    ...
                    if ("INPUT" === e.target.nodeName) {
                        var t = r.state.get("value"), n = e.target.value;
                ...
                }), t.aria("expanded", !0)), t.menu.show(), t.menu.layoutRect({w: t.layoutRect().w}), t.menu.moveRel(t.getEl(), t.isRtl() ? ["br-tr", "tr-br"] : ["bl-tl", "tl-bl"])
            }, focus: function () {
                this.getEl("inp").focus()
            }, repaint: function () {
                var e, t, n = this, i = n.getEl(), r = n.getEl("open"), o = n.layoutRect(), s = 0, a = i.firstChild;
                ...
                var e, t, n, i = this, r = i._id, o = i.settings, s = i.classPrefix, a = i.state.get("value") || "", l = "",
                    u = "";
                ...
                r.state.on("change:value", function (e) {
                    ...
                    var t = r.getEl("status"), n = r.classPrefix, i = e.value;
            ...
            init: function (e) {
                ...
                var t = this.getEl("open"), n = t ? t.getElementsByTagName("i")[0] : null;
                if (n) try {
            ...
            init: function (e) {
                ...
                var e = this, t = e._id, n = e.classPrefix, i = e.state.get("text"),
                    r = e.settings.icon ? n + "ico " + n + "i-" + e.settings.icon : "",
                    o = e.settings.image ? " style=\"background-image: url('" + e.settings.image + "')\"" : "", s = "";
                ...
                var t = this, n = t.settings.onclick;
        ...
        }), cn = tinymce.util.Tools.resolve("tinymce.util.Color"), dn = zt.extend({
            Defaults: {classes: "widget colorpicker"}, init: function (e) {
                this._super(e)
            }, postRender: function () {
                var n, i, r, o, s, a = this, l = a.color();
                ...
                function c(e, t) {
                    var n = (360 - e.h) / 360;
                    He.css(r, {top: 100 * n + "%"}), t || He.css(s, {
                        left: e.s + "%",
                        top: 100 - e.v + "%"
                    }), o.style.background = cn({s: 100, v: 100, h: e.h}).toHex(), a.color().parse({
                        s: e.s,
                        v: e.v,
                        h: e.h
                    })
                ...
                i = a.getEl("h"), r = a.getEl("hp"), o = a.getEl("sv"), s = a.getEl("svp"), a._repaint = function () {
                    ...
                    start: e,
                    drag: e
                }), a._hdraghelper = new pt(a._id + "-h", {start: t, drag: t}), a._repaint()
            }, rgb: function () {
                ...
                var e, t = this._id, o = this.classPrefix,
            ...
            init: function (e) {
                ...
                var t, n, i = e || [], r = "", o = this.classPrefix;
            ...
            postRender: function () {
                var o = this, s = o.settings.editor;
            ...
            Defaults: {
                ...
                function e() {
                    ...
                    if (!1 !== n.settings.labelGapCalc) for (("children" === n.settings.labelGapCalc ? n.find("formitem") : n.items()).filter("formitem").each(function (e) {
                        var t = e.items()[0], n = t.getEl().clientWidth;
                        i = i < n ? n : i, r.push(t)
            ...
            fromHtml: function (e, t) {
                ...
                return xn(n)
            }, fromDom: xn, fromPoint: function (e, t, n) {
                return D.from(e.dom().elementFromPoint(t, n)).map(xn)
            }
        }, _n = function (e) {
            var t, n = !1;
            return function () {
            ...
            }, each: Tn, map: function (e, i) {
                return Pn(e, function (e, t, n) {
                    return {k: t, v: i(e, t, n)}
                })
            }, mapToArray: Wn, tupleMap: Pn, find: function (e, t) {
                for (var n = Mn(e), i = 0, r = n.length; i < r; i++) {
                    var o = n[i], s = e[o];
                    if (t(s, o, e)) return D.some(s)
                }
                return D.none()
            }, keys: Mn, values: Dn, size: function (e) {
                return Dn(e).length
            }
        }, An = function (e) {
            return e.slice(0).sort()
        }, Bn = {
            sort: An, reqMessage: function (e, t) {
                ...
                throw new Error("All values need to be of type: " + t + ". Keys (" + An(e).join(", ") + ") were not.")
            ...
            immutable: function () {
                ...
                return Bn.validateStrArr("required", r), Bn.validateStrArr("optional", o), Bn.checkDupes(s), function (t) {
                    var n = Nn.keys(t);
                    ...
                    0 < e.length && Bn.unsuppMessage(e);
                    var i = {};
                    return oe.each(r, function (e) {
                        i[e] = H.constant(t[e])
                    }), oe.each(o, function (e) {
                        i[e] = H.constant(Object.prototype.hasOwnProperty.call(t, e) ? D.some(t[e]) : D.none())
                    }), i
                }
            }
        }, zn = ("undefined" != typeof window ? window : Function("return this;")(), function (e, t) {
            var n = function (e, t) {
            ...
            nu: In, detect: function (e, t) {
                var n = String(t).toLowerCase();
                return 0 === e.length ? Ln() : zn(e, n)
            }, unknown: Ln
        }, Un = "Firefox", Vn = function (e, t) {
            return function () {
                return t === e
            }
        }, jn = function (e) {
            ...
            unknown: function () {
                return jn({current: undefined, version: Fn.unknown()})
            },
            nu: jn,
            ...
            firefox: H.constant(Un),
            safari: H.constant("Safari")
        }, Yn = "Windows", $n = "Android", Xn = "Solaris", Jn = "FreeBSD", Gn = function (e, t) {
            return function () {
                return t === e
            }
        }, Kn = function (e) {
            ...
            unknown: function () {
                return Kn({current: undefined, version: Fn.unknown()})
            },
            nu: Kn,
            windows: H.constant(Yn),
            ios: H.constant("iOS"),
            android: H.constant($n),
            linux: H.constant("Linux"),
            osx: H.constant("OSX"),
            solaris: H.constant(Xn),
            freebsd: H.constant(Jn)
        }, Qn = function (e, t) {
            var n = String(t).toLowerCase();
        ...
        }, ii = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, ri = function (t) {
            return function (e) {
                return ni(e, t)
            }
        }, oi = [{
            name: "Edge", versionRegexes: [/.*?edge\/ ?([0-9]+)\.([0-9]+)$/], search: function (e) {
                return ni(e, "edge/") && ni(e, "chrome") && ni(e, "safari") && ni(e, "applewebkit")
            }
        }, {
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, ii], search: function (e) {
                return ni(e, "chrome") && !ni(e, "chromeframe")
            }
        }, {
            name: "IE",
            versionRegexes: [/.*?msie\ ?([0-9]+)\.([0-9]+).*/, /.*?rv:([0-9]+)\.([0-9]+).*/],
            search: function (e) {
                return ni(e, "msie") || ni(e, "trident")
            }
        }, {name: "Opera", versionRegexes: [ii, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: ri("opera")}, {
            name: "Firefox",
            versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
            search: ri("firefox")
        }, {
            name: "Safari", versionRegexes: [ii, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
                return (ni(e, "safari") || ni(e, "mobile/")) && ni(e, "applewebkit")
            }
        }], si = [{
            name: "Windows",
            search: ri("win"),
            ...
            name: "iOS",
            search: function (e) {
                return ni(e, "iphone") || ni(e, "ipad")
            },
            versionRegexes: [/.*?version\/\ ?([0-9]+)\.([0-9]+).*/, /.*cpu os ([0-9]+)_([0-9]+).*/, /.*cpu iphone os ([0-9]+)_([0-9]+).*/]
        }, {name: "Android", search: ri("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]}, {
            name: "OSX",
            search: ri("os x"),
            versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/]
        }, {name: "Linux", search: ri("linux"), versionRegexes: []}, {
            name: "Solaris",
            search: ri("sunos"),
            versionRegexes: []
        }, {name: "FreeBSD", search: ri("freebsd"), versionRegexes: []}],
        ai = {browsers: H.constant(oi), oses: H.constant(si)}, li = function (e) {
            var t, n, i, r, o, s, a, l, u, c, d, f = ai.browsers(), h = ai.oses(), m = ei(f, e).fold(qn.unknown, qn.nu),
                g = ti(h, e).fold(Zn.unknown, Zn.nu);
            return {
                browser: m,
                os: g,
            ...
            return li(e)
        }), ci = Cn, di = Rn, fi = function (e) {
            return e.nodeType !== ci && e.nodeType !== di || 0 === e.childElementCount
        }, hi = {
            all: function (e, t) {
                var n = t === undefined ? document : t.dom();
                return fi(n) ? [] : oe.map(n.querySelectorAll(e), wn.fromDom)
            }, is: function (e, t) {
                var n = e.dom();
                if (n.nodeType !== ci) return !1;
                ...
                var n = t === undefined ? document : t.dom();
                return fi(n) ? D.none() : D.from(n.querySelector(e)).map(wn.fromDom)
            }
        }, mi = (ui().browser.isIE(), On.immutable("element", "offset"), function (e, t) {
            return hi.all(t, e)
        }), gi = w.trim, pi = function (t) {
            return function (e) {
                if (e && 1 === e.nodeType) {
        ...
        }, vi = pi("true"), bi = pi("false"), yi = function (e, t, n, i, r) {
            ...
            return yi("header", xi(e), "#" + i, _i(n = e) ? parseInt(n.nodeName.substr(1), 10) : 0, function () {
                e.id = i
            })
        }, Ei = function (e) {
            var t = e.id || e.name, n = xi(e);
            return yi("anchor", n || "#" + t, "#" + t, 0, H.noop)
        }, Hi = function (e) {
            var t, n;
            return t = "h1,h2,h3,h4,h5,h6,a:not([href])", n = e, oe.map(mi(wn.fromDom(n), t), function (e) {
                return e.dom()
            })
        }, Si = function (e) {
            return 0 < gi(e.title).length
        }, Mi = function (e) {
            var t, n, i = Hi(e);
            return oe.filter((n = i, oe.map(oe.filter(n, Ci), ki)).concat((t = i, oe.map(oe.filter(t, wi), Ei))), Si)
        }, Ti = {}, Pi = function (e) {
            ...
            var n, o, s, a, l = {title: "-"}, u = function (e) {
                var t = e.hasOwnProperty(r) ? e[r] : [], n = oe.filter(t, function (e) {
                ...
                return e = n, w.map(e, Pi)
            };
            return !1 === t.typeahead_urls ? [] : "file" === r ? (n = [Ai(e, u(Ti)), Ai(e, c("header")), Ai(e, (o = c("anchor"), s = Di(t, "anchor_top", "#top"), a = Di(t, "anchor_bottom", "#bottom"), null !== s && o.unshift(Wi("<top>", s)), null !== a && o.push(Wi("<bottom>", a)), o))], oe.foldl(n, function (e, t) {
                return 0 === e.length || 0 === t.length ? e.concat(t) : e.concat(l, t)
            }, [])) : Ai(e, u(Ti))
        }, Ai = function (e, t) {
            var n = e.toLowerCase(), i = w.grep(t, function (e) {
                return -1 !== e.title.toLowerCase().indexOf(n)
            });
            return 1 === i.length && i[0].title === e ? [] : i
        }, Bi = function (r, i, o, s) {
            var t = function (e) {
                var t = Mi(o), n = Ni(e, t, s, i);
            ...
            r.on("autocomplete", function () {
                ...
                "image" === s ? r.fire("change", {meta: {alt: i, attach: t.attach}}) : r.fire("change", {
                    meta: {
                        text: i,
                        attach: t.attach
                    }
                ...
                r.getRoot().on("submit", function (e) {
                    var t, n, i;
                    e.isDefaultPrevented() || (t = r.value(), i = Ti[n = s], /^https?/.test(t) && (i ? oe.indexOf(i, t).isNone() && (Ti[n] = i.slice(0, 5).concat(t)) : Ti[n] = [t]))
                })
            })
        }, Oi = function (o, e, n) {
            ...
            i && o.state.on("change:value", function (e) {
                var t;
                0 !== (t = e.value).length ? i({url: t, type: n}, function (e) {
                    var t, n, i, r = (n = (t = e).status, i = t.message, "valid" === n ? {
                        status: "ok",
                        message: i
                    } : "unknown" === n ? {status: "warn", message: i} : "invalid" === n ? {
                        status: "warn",
                        message: i
                    } : {status: "none", message: ""});
            ...
            Statics: {
                ...
                var t, n, i, r = this, o = window.tinymce ? window.tinymce.activeEditor : l.activeEditor, s = o.settings,
                    a = e.filetype;
                e.spellcheck = !1, (i = s.file_picker_types || s.file_browser_callback_types) && (i = w.makeMap(i, /[, ]/)), i && !i[a] || (!(n = s.file_picker_callback) || i && !i[a] ? !(n = s.file_browser_callback) || i && !i[a] || (t = function () {
                    ...
                    e = w.extend({filetype: a}, e), n.call(o, function (e, t) {
                        r.value(e).fire("change", {meta: t})
                    }, r.value(), e)
                }), t && (e.icon = "browse", e.onaction = t), r._super(e), r.classes.add("filepicker"), Bi(r, s, o.getBody(), a), Oi(r, s, a)
            }
        }), Li = Zt.extend({
            recalc: function (e) {
            ...
            recalc: function (e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, R, C, k, E, H, S, M, T, P, W, D, N, A,
                    B, O, z = [], L = Math.max, I = Math.min;
            ...
            n.addMenuItem("align", {
                text: "Align",
                menu: [{text: "Left", icon: "alignleft", onclick: Vi(n, "alignleft")}, {
                    text: "Center",
                    icon: "aligncenter",
                    onclick: Vi(n, "aligncenter")
                }, {text: "Right", icon: "alignright", onclick: Vi(n, "alignright")}, {
                    text: "Justify",
                    icon: "alignjustify",
                    onclick: Vi(n, "alignjustify")
                }]
            }), w.each({
                ...
                n.addButton(t, {active: !1, tooltip: e[0], cmd: e[1], onPostRender: ji(n, t)})
            })
        }, Yi = function (e) {
            return e ? e.split(",")[0] : ""
        }, $i = function (a, l) {
            return function () {
                ...
                a.on("init nodeChange", function (e) {
                    var t, n, i, r = a.queryCommandValue("FontName"), o = (t = l, n = r, w.each(t, function (e) {
                        e.value.toLowerCase() === n.toLowerCase() && (i = e.value)
                    }), w.each(t, function (e) {
                        i || Yi(e.value).toLowerCase() !== Yi(n).toLowerCase() || (i = e.value)
                    }), i);
                    s.value(o || null), !o && r && s.text(Yi(r))
                })
            }
        }, Xi = function (n) {
                ...
                return {
                    ...
                    onPostRender: (s = n, a = t, function () {
                        ...
                        s.on("init nodeChange", function (e) {
                            var t, n, i, r;
                            if (t = s.queryCommandValue("FontSize")) for (i = 3; !r && 0 <= i; i--) n = Gi(t, i), r = Ki(a, n, t);
            ...
            return e.items().each(function (e) {
                e.menu && e.visible(0 < tr(n, e.menu)), !e.menu && e.settings.menu && e.visible(0 < er(n, e.settings.menu));
            ...
            var i, r, o, t, s, n, a, l, u = (r = 0, o = [], t = [{
                ...
                if (e) return w.each(e, function (e) {
                    ...
                    if (e.items) t.menu = s(e.items); else {
                ...
                itemDefaults: {
                    preview: !0, textStyle: function () {
                        ...
                        this.settings.format && Vi(i, this.settings.format)(), this.settings.cmd && i.execCommand(this.settings.cmd)
                    }
                }
            });
            n = u, e.addMenuItem("formats", {
                ...
                menu: l,
                onShowMenu: function () {
                    a.settings.style_formats_autohide && tr(a, this.menu)
                }
            })
        }, ir = function (n, e) {
            return function () {
                ...
                return w.each(e, function (e) {
                    ...
                    type: "listbox", text: e[0][0], values: t, fixedWidth: !0, onselect: function (e) {
                        if (e.control) {
            ...
            e.addMenuItem("blockformats", {
                text: "Blocks", menu: (t = e, n = i, w.map(n, function (e) {
                    return {
                        text: e[0], onclick: Vi(t, e[1]), textStyle: function () {
                            return t.formatter.getCssText(e[1])
                        }
                    }
                }))
            }), e.addButton("formatselect", ir(e, i))
        }, or = function (t, e) {
            var n, i;
            if ("string" == typeof e) i = e.split(" "); else if (w.isArray(e)) return oe.flatten(w.map(e, function (e) {
                return or(t, e)
            }));
            ...
            var t = oe.filter(e, function (e, t, n) {
                return !sr(e) || !sr(n[t - 1])
            });
            return oe.filter(t, function (e, t, n) {
                return !sr(e) || 0 < t && t < n.length - 1
            })
        }, lr = function (e) {
            var t, n, i, r, o = e.settings.insert_button_items;
            return ar(o ? or(e, o) : (t = e, n = "insert", i = [{text: "-"}], r = w.grep(t.menuItems, function (e) {
                return e.context === n
            }), w.each(r, function (e) {
            ...
            (t = e).addButton("insert", {
                type: "menubutton", icon: "insert", menu: [], oncreatemenu: function () {
                    this.menu.add(lr(t)), this.menu.renderNew()
                }
            })
        }, cr = function (e) {
            var n, i, r;
            n = e, w.each({
                ...
                n.addButton(t, {active: !1, tooltip: e, onPostRender: ji(n, t), onclick: Vi(n, t)})
            }), i = e, w.each({
                ...
                r.addButton(t, {active: !1, tooltip: e[0], cmd: e[1], onPostRender: ji(r, t)})
            })
        }, dr = function (e) {
            var n;
            cr(e), n = e, w.each({
            ...
            }), n.addMenuItem("codeformat", {text: "Code", icon: "code", onclick: Vi(n, "code")})
        }, fr = function (n, i) {
            return function () {
            ...
            (t = e).addMenuItem("undo", {
                ...
                icon: "undo",
                shortcut: "Meta+Z",
                onPostRender: fr(t, "undo"),
                cmd: "undo"
            }), t.addMenuItem("redo", {
                text: "Redo",
                icon: "redo",
                shortcut: "Meta+Y",
                onPostRender: fr(t, "redo"),
                cmd: "redo"
            }), (n = e).addButton("undo", {
                tooltip: "Undo",
                onPostRender: fr(n, "undo"),
                cmd: "undo"
            }), n.addButton("redo", {tooltip: "Redo", onPostRender: fr(n, "redo"), cmd: "redo"})
        }, mr = function (e) {
            var t, n;
            (t = e).addMenuItem("visualaid", {
                text: "Visual aids", selectable: !0, onPostRender: (n = t, function () {
                    var t = this;
            ...
            setup: function (e) {
                ...
                e.rtl && (ct.rtl = !0), e.on("mousedown", function () {
                    Tt.hideAll()
                }), (t = e).settings.ui_container && (pe.container = Ui(wn.fromDom(document.body), t.settings.ui_container).fold(H.constant(null), function (e) {
                    return e.dom()
                })), zt.tooltips = !pe.iOS, ct.translate = function (e) {
                    return l.translate(e)
                }, rr(e), qi(e), dr(e), hr(e), Qi(e), Ji(e), nr(e), mr(e), ur(e)
            }
        }, pr = Zt.extend({
            recalc: function (e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, R, C, k, E, H, S, M = [], T = [];
                ...
                for (f = 0; f < n; f++) for (d = 0; d < i && (c = r[f * i + d]); d++) C = (u = c.layoutRect()).minW, k = u.minH, M[d] = C > M[d] ? C : M[d], T[f] = k > T[f] ? k : T[f];
            ...
            init: function (e) {
                ...
                var e, t, n = this, i = n.settings.forId,
            ...
            init: function (e) {
                ...
                }).fire("show")), n.menu.show(), n.menu.layoutRect({w: n.layoutRect().w}), n.menu.repaint(), n.menu.moveRel(n.getEl(), n.isRtl() ? ["br-tr", "tr-br"] : ["bl-tl", "tl-bl"]), n.fire("showmenu")
            }, hideMenu: function () {
                ...
                var e, t = this, n = t._id, i = t.classPrefix, r = t.settings.icon, o = t.state.get("text"), s = "";
                return (e = t.settings.image) ? (r = "none", "string" != typeof e && (e = window.getSelection ? e[0] : e[1]), e = " style=\"background-image: url('" + e + "')\"") : e = "", o && (t.classes.add("btn-has-text"), s = '<span class="' + i + 'txt">' + t.encode(o) + "</span>"), r = t.settings.icon ? i + "ico " + i + "i-" + r : "", t.aria("role", t.parent() instanceof wr ? "menuitem" : "button"), '<div id="' + n + '" class="' + t.classes + '" tabindex="-1" aria-labelledby="' + n + '"><button id="' + n + '-open" role="presentation" type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + e + "></i>" : "") + s + ' <i class="' + i + 'caret"></i></button></div>'
            }, postRender: function () {
                var r = this;
                return r.on("click", function (e) {
                    ...
                    var t, n = e.control, i = r.parent();
                    n && i && n instanceof _r && n.parent() === i && (i.items().filter("MenuButton").each(function (e) {
            ...
            Defaults: {
                ...
                n.settings.itemsFactory && (n.throbber || (n.throbber = new Nt(n.getEl("body"), !0), 0 === n.items().length ? (n.throbber.show(), n.fire("loading")) : n.throbber.show(100, function () {
            ...
            init: function (i) {
                ...
                return i.on("show", function (e) {
                    var t, n;
                    t = e.control, n = i.value(), t instanceof Rr && t.items().each(function (e) {
            ...
            Defaults: {border: 0, role: "menuitem"}, init: function (e) {
                ...
                var t, n = this, e = n.settings, i = n.parent();
                ...
                var e, t = this, n = t._id, i = t.settings, r = t.classPrefix, o = t.state.get("text"), s = t.settings.icon,
                    a = "", l = i.shortcut, u = t.encode(i.url);
                ...
                return s && t.parent().classes.add("menu-has-icons"), i.image && (a = " style=\"background-image: url('" + i.image + "')\""), l && (l = function (e) {
                    ...
                    for (i = pe.mac ? {
                        ...
                        shift: "&#x21E7;",
                        meta: "&#x2318;"
                    } : {meta: "Ctrl"}, e = e.split("+"), t = 0; t < e.length; t++) (n = i[e[t].toLowerCase()]) && (e[t] = n);
                    return e.join("+")
                ...
                var t = this, n = t.settings, e = n.textStyle;
        ...
        }), Er = nn.extend({Defaults: {classes: "radio", role: "radio"}}), Hr = zt.extend({
            renderHtml: function () {
                var e = this, t = e.classPrefix;
    ...
    var Mr = zt.extend({
        Defaults: {classes: "selectbox", role: "selectbox", options: []}, init: function (e) {
            ...
            var e, t = this, n = "";
            return e = Sr(t._options), t.size && (n = ' size = "' + t.size + '"'), '<select id="' + t._id + '" class="' + t.classes + '"' + n + ">" + e + "</select>"
        }, bindStates: function () {
            var t = this;
            return t.state.on("change:options", function (e) {
                t.getEl().innerHTML = Sr(e.value)
            }), t._super()
        }
    });
    ...
    function Wr(e, t) {
        var n, i, r, o, s;
        "v" === e.settings.orientation ? (r = "top", i = "height", n = "h") : (r = "left", i = "width", n = "w"), s = e.getEl("handle"), o = ((e.layoutRect()[n] || 100) - He.getSize(s)[i]) * ((t - e._minValue) / (e._maxValue - e._minValue)) + "px", s.style[r] = o, s.style.height = e.layoutRect().h + "px", Pr(s, "valuenow", t), Pr(s, "valuetext", "" + e.settings.previewFilter(t)), Pr(s, "valuemin", e._minValue), Pr(s, "valuemax", e._maxValue)
    }
    ...
    var Dr = zt.extend({
        init: function (e) {
            ...
            e = m._minValue, t = m._maxValue, "v" === m.settings.orientation ? (n = "screenY", i = "top", r = "height", o = "h") : (n = "screenX", i = "left", r = "width", o = "w"), m._super(), function (o, s) {
                function t(e) {
                    var t, n, i, r;
                    t = Tr(t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + .05 * e) * (i - n) - n, o, s), m.value(t), m.fire("dragstart", {value: t}), m.fire("drag", {value: t}), m.fire("dragend", {value: t})
                }
                ...
                handle: m._id + "-handle",
                start: function (e) {
                    u = e[n], c = parseInt(m.getEl("handle").style[i], 10), d = (m.layoutRect()[o] || 100) - He.getSize(l)[r], m.fire("dragstart", {value: h})
                },
                drag: function (e) {
                    var t = e[n] - u;
                    f = Tr(c + t, 0, d), l.style[i] = f + "px", h = s + f / d * (a - s), m.value(h), m.tooltip().text("" + m.settings.previewFilter(h)).show().moveRel(l, "bc tc"), m.fire("drag", {value: h})
                },
                stop: function () {
        ...
        Defaults: {layout: "absolute", defaults: {type: "panel"}}, activateTab: function (n) {
            var e;
            ...
            var i = this, e = i._layout, r = "", o = i.classPrefix;
        ...
        n.ui ? w.each(Lr(), function (e, t) {
            n.ui[t] = e
        }) : n.ui = Lr()
    };
    w.each(Lr(), function (e, t) {
        v.add(t, e)
    }), Ir(window.tinymce ? window.tinymce : {}), o.add("modern", function (e) {
        return gr.setup(e), Gt(e)
    })
}();