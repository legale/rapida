	...
	<div class="column_right">
		...
		<div class="block">
			...
			<ul>
				...
				<li><input type="checkbox" name="tpl" {if $feature['tpl']}checked{/if} value="1">
					<label>Разрешить переменные &#123;${$feature['trans']}&#125; &#123;${$feature['trans']}_list&#125; &#123;${$feature['trans']}_2r&#125;  &#123;${$feature['trans']}_3r&#125;  &#123;${$feature['trans']}_4r&#125; для мета тегов</label></li>
