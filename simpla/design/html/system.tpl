...
{capture name=tabs}
	...
	{if in_array('export', $manager->permissions)}<li><a href="index.php?module=BackupAdmin">Бекап</a></li>{/if}
	<li class="active"><a href="index.php?module=SystemAdmin">Обслуживание системы</a></li>
{/capture}
