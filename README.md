...
- Сделана дополнительная проверка имен свойств в методе features->add_feature() для исключения создания дублей одинаковых свойств. Необходимо выполнить запрос к БД:
```
