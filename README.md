...
$filter в методе $get это массив в виде пар 'поле' => 'значение'. Для получения всех изображений товара с id 1 обращение к методу будет следующим: 
$this->image->get('products', array('item_id' => 1))
Так можно получить основное изображение нужного товара:
$this->image->get('products', array('item_id' => 1, 'pos' => 0))
