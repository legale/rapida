...
if($response['OrderNumber'] !=  $order_id)
	errorlink("incorrect order number\n");
     
// Установим статус оплачен
$alfa['orders']->update_order(intval($order_id), array('paid'=>1));

// Спишем товары  
$alfa['orders']->close(intval($order_id));
$alfa['notify']->email_order_user(intval($order_id));
$alfa['notify']->email_order_admin(intval($order_id));
