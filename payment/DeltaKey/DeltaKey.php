...
class DeltaKey extends Simpla
{
	...
	public function checkout_form($order_id, $button_text = null)
	{
		...
		$param = $order_id. $settings['num_shop'].$settings['keyt_shop'].'1'.$price.'Order '.$order_id;
		...
		$button = '<form method="POST" action="'.$payment_url.'">
					...
					<input type=hidden name="ext_transact" value="'.$order_id.'">
					<input type=hidden name="comment" value="Order '.$order_id.'">
