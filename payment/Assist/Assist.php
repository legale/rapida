...
{	
	public function checkout_form($order_id, $button_text = null)
	{
		...
		$hashcode = strtoupper(md5(strtoupper(md5( $settings['assist_key'] ).md5( $settings['assist_merchant_id'] . $order_id .  $order['total_price'] . str_replace("RUR", "RUB", $payment_currency['code'])))));
