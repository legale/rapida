...
<div class="links">	
	...
	{if $current_page_num==2}<a class="prev_page_link" href="{url page=null}">&laquo; назад</a>{/if}
	{if $current_page_num>2}<a class="prev_page_link" href="{url page=$current_page_num-1}">&laquo; назад</a>{/if}	
	...
	{if $current_page_num<$total_pages_num}<a class="next_page_link" href="{url page=$current_page_num+1}">вперед &raquo;</a>{/if}
</div>	
</div>
