...
CREATE TABLE `s_categories_features` (
  ...
  UNIQUE KEY `fid_cid` (`feature_id`,`category_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `s_options` (
  ...
  `63` mediumint(9) NOT NULL DEFAULT 0,
  `64` mediumint(9) NOT NULL DEFAULT 0,
  `65` mediumint(9) NOT NULL DEFAULT 0,
...
CREATE TABLE `s_orders` (
  ...
  `modified` timestamp NOT NULL DEFAULT '1970-01-02 00:00:00',
  PRIMARY KEY (`id`),
  KEY `login` (`user_id`),
...
CREATE TABLE `s_products_categories` (
  ...
  KEY `position` (`position`),
  KEY `category_id` (`category_id`,`product_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(1, 0x2eb6578788b3557c787f3a8d5252f1ec, '', '$this->brand->get_brands(array (\n  \'var\' => \'all_brands\',\n  \'force_no_cache\' => true,\n));');
